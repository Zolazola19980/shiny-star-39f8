...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shiny-star-39f8
```

A live public deployment of this template is available at [https://shiny-star-39f8.templates.workers.dev](https://shiny-star-39f8.templates.workers.dev)
